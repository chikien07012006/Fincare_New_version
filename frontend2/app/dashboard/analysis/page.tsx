...
const mockAnalysisData = {
  overallScore: 78,
  categories: [
    { category: "Credit Score", score: 85, maxScore: 100, factor: "Credit Score", impact: 15 },
    { category: "Cash Flow", score: 75, maxScore: 100, factor: "Cash Flow", impact: 10 },
    { category: "Collateral", score: 80, maxScore: 100, factor: "Collateral Value", impact: 12 },
    { category: "Business History", score: 70, maxScore: 100, factor: "Business Age", impact: 8 },
    { category: "Industry Risk", score: 65, maxScore: 100, factor: "Industry Risk", impact: -5 },
    { category: "Debt Ratio", score: 72, maxScore: 100, factor: "Debt-to-Income", impact: -3 },
  ],
  recommendations: [
    "Your credit score is strong, which improves your loan terms significantly.",
    "Consider reducing debt-to-income ratio to qualify for better rates.",
    "Your collateral value provides good security for lenders.",
    "Business age and history are favorable factors in your application.",
  ],
}
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="visual" className="space-y-8 mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="relative h-40 w-40">
                      <svg className="transform -rotate-90 h-40 w-40">
                        ...
                        <circle
                          ...
                          strokeDashoffset={`${2 * Math.PI * 70 * (1 - mockAnalysisData.overallScore / 100)}`}
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  {mockAnalysisData.categories.map((category, index) => (
            ...
            <BarChartComponent
              data={mockAnalysisData.categories.map((cat) => ({
                factor: cat.factor,
                impact: cat.impact,
              }))}
            />
            ...
            {/* Radar Chart */}
            <RadarChartComponent data={mockAnalysisData.categories} />
